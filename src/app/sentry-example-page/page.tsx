    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://yo-self.sentry.io/issues/?project=4509968279273472">Issues Page</a>.
