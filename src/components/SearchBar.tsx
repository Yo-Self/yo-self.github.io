    ...
    >
      ...
      >
        <svg width="34" height="34" viewBox="0 0 24 24" fill="none" style={{ display: 'block' }}>
          {/* Contorno da lupa (outline) com cor sólida */}
          <circle cx="10.5" cy="10.5" r="7" className="stroke-gray-700 dark:stroke-white" strokeWidth="2.5" fill="none" />
          <line x1="21" y1="21" x2="15.5" y2="15.5" className="stroke-gray-700 dark:stroke-white" strokeWidth="2.5" strokeLinecap="round" />
        </svg>
      </button>
