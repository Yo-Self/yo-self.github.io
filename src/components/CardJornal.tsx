...
export default function CardJornal({ dish, onClick, size = "small" }: CardJornalProps) {
  return (
    <div
    ...
    >
      <div className="relative w-full">
        ...
        {/* Nome do prato, canto inferior esquerdo sobre a foto */}
      ...
      <div className="w-full px-3 pt-2 pb-2">
        <p className="text-sm text-gray-600 dark:text-gray-300 mb-0">{dish.description}</p>
      </div>
    </div>
  );
} 